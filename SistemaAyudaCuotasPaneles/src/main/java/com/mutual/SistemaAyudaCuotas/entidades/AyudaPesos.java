...
@Entity
@Table(name = "AYUDAS_PESOS")
public class AyudaPesos {
	
	@Id
   @GeneratedValue(strategy = GenerationType.IDENTITY) // Autoincremental
	@Column(name = "ID_AYUDA_PESOS")
    private Long idAyudaPesos;
	...
	@Column(name = "FECHA_ORIG_LEGALES")
	@Temporal(TemporalType.DATE)
	private Date fechaOrigLegales;					// ORIGLEG
	...
	public AyudaPesos(Long idAyudaPesos, Integer nroAyuda, Integer numeroSocio, Date fechaAltaAyuda,
			...
			Date fechaOrigLegales, BigDecimal montoSelladoPcial, Integer garantia, String observaciones,
			Integer nroSocioGarante2, Integer nroSocioGarante3, BigDecimal montoEfectivo, BigDecimal montoTransferencia,
			Integer nroCheque1, String bancoCheque1, BigDecimal montoCheque1, Integer nroCheque2, String bancoCheque2,
			BigDecimal montoCheque2, Integer nroCheque3, String bancoCheque3, BigDecimal montoCheque3, String novacion,
			String seguro) {
		super();
		this.idAyudaPesos = idAyudaPesos;
		...
		this.fechaOrigLegales = fechaOrigLegales;
	...
	public Long getIdAyudaPesos() {
		return idAyudaPesos;
	}

	public void setIdAyudaPesos(Long idAyudaPesos) {
		this.idAyudaPesos = idAyudaPesos;
	}
	...
	public Date getFechaOrigLegales() {
		return fechaOrigLegales;
	}

	public void setFechaOrigLegales(Date fechaOrigLegales) {
		this.fechaOrigLegales = fechaOrigLegales;
	}
